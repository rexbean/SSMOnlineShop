package com.rex.onlineShop.cache;
...
public class JedisUtil {
    ...
    /**
     * get jedis from the connection pol
     * @return jedis
     */
    ...
    public class Keys {
        ...
        /**
         * change key only when new key does not exist
         * @param oldkey old
         * @param newkey new
         * @return status
         */
         ...
         * @param key key
         * @param seconds seconds
         * @return counts will be effected
         */
        ...
        /**
         * set expiration time with timestamp(1970.1.1 00:00:00)
         * @param key key
         * @param timestamp timestamp
         * @return numbers will be effected
         */
